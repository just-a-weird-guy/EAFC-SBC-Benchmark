...
const usage = `
Validate one solver output against one challenge and the official player pool.

Usage:
  node evaluator/validate-solution.mjs --challenge <file> --players <file> --solution <file>
`;
